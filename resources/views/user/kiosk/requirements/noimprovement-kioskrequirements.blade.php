...
<head>
  ...
  <title>No Improvement Requirements</title>
...
<body class="m-0 p-0 bg-gray-100">
        ...
        <form class="flex flex-col flex-1 min-h-0">
          ...
          <div class="pt-4 border-t border-gray-300 mt-4">
            <button
              ...
              :disabled="!canProceed"
              @click="openReminder()"
              :class="canProceed ? 'bg-amber-600 hover:bg-amber-700 cursor-pointer' : 'bg-amber-400 cursor-not-allowed opacity-60'"
  ...
  <script>
    function requirementFormHandler() {
      ...
      const serviceType = urlParams.get('service_type') || 'Certificate of No Improvement';
