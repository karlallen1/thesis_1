...
<head>
  ...
  <title>No Improvement Application</title>
...
<body>
  <div class="container">
    <h1>No Improvement Application</h1>
  ...
  <script>
    function formApp() {
      return {
        ...
        resetForm() {
          this.form = { email: '', contact: '', first_name: '', middle_name: '', last_name: '', birthdate: '', is_pwd: 'no', pwd_id: '', senior_id: '', service_type: 'No Improvement' };
