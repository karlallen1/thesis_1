...
<head>
  ...
  <title>Property Holdings Application - North Caloocan City Hall</title>
...
<body class="bg-gradient-to-br from-blue-50 to-gray-50 min-h-screen">
  ...
  <div class="max-w-2xl mx-auto mt-4 p-6 md:p-8">
    <div class="text-center mb-8">
      ...
      <h1 class="text-3xl font-bold text-gray-800" data-i18n="property_holdings_application">Property Holdings Application</h1>
