...
<head>
  ...
  <style>
    ...
    /* Pulse animation for loading text (kept in case used elsewhere) */
    .pulse-text {
...
<body class="bg-gray-100 font-sans text-gray-800">
  <div class="max-w-xl mx-auto mt-12 p-6 bg-white shadow-xl rounded-xl">
    <h1 class="text-3xl font-bold text-center text-blue-700 mb-6">Tax Declaration Application Form</h1>
    <form @submit.prevent="showModal" class="space-y-5">
      ...
      <div class="pt-4">
        <button type="submit"
          ...
          :class="!isFormValid || isSubmitting ? 'bg-gray-400 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700'"
    ...
    <div class="bg-white p-6 rounded-xl shadow-lg w-full max-w-lg mx-auto">
      ...
      <div class="flex justify-end gap-4 mt-6">
        ...
        <button @click="submitForm" 
          ...
          class="bg-green-600 text-white px-4 py-2 rounded text-sm flex items-center space-x-2">
          
          <svg x-show="isSubmitting" class="spinner w-4 h-4" fill="none" viewBox="0 0 24 24">
            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
          </svg>
          <span x-text="isSubmitting ? 'Processing...' : 'Confirm & Submit'"></span>
        </button>
      </div>
    </div>
  </div>
...
<div x-show="isSubmitting" x-transition class="fixed inset-0 bg-black bg-opacity-60 z-50 flex items-center justify-center">
  <div class="bg-white p-8 rounded-xl shadow-lg w-full max-w-md text-center">
    ...
    <!-- Progress bar only (no percentage) -->
  ...
  <script>
    function formApp() {
      return {
        ...
        // Start loading animation (progress only)
