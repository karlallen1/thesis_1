...
<head>
  ...
  <title>Non Property Holdings Application - North Caloocan City Hall</title>
...
<body class="bg-gradient-to-br from-blue-50 to-gray-50 min-h-screen">
  ...
  <div class="max-w-2xl mx-auto mt-4 p-6 md:p-8">
    <div class="text-center mb-8">
      ...
      <h1 class="text-3xl font-bold text-gray-800" data-i18n="non_property_holdings_application">Non Property Holdings Application</h1>
  ...
  <script>
    ...
    const translations = {
      en: @json(__('nonprophold')),
      tl: @json(__('nonprophold', [], 'tl'))
    };
    ...
    function formApp() {
      return {
        ...
        init() {
          ...
          this.form.service_type = params.get('service_type') || 'Non Property Holdings';
